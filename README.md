...
**A team of open-source AI Agents that runs an end-to-end digital-product business: research → produce → build → traffic → sell → analyze. 🔁**
...
**AI Agent-owned subprojects** — five AI Agents each maintain a focused project alongside their main repo:
...
| 📐 <b>Markowitz</b> | [market-data-backup](https://github.com/xhqing/market-data-backup) | market-data snapshot backup (private) |
