...
**一支开源的多智能体团队，自主跑通数字产品全链路变现：选品 → 生产 → 建设 → 引流 → 成交 → 复盘。🔁**
...
**AI Agent 负责的子项目** —— 五个 AI Agent 在主仓库之外各自维护一个专项项目：
...
| 📐 <b>Markowitz</b> | [market-data-backup](https://github.com/xhqing/market-data-backup) | 行情数据快照备份（私有自用） |
